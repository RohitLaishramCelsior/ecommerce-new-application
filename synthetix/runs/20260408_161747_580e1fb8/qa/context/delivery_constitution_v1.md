...
- Constitution ID: const-de94190accab
- Run ID: 20260408_161747_580e1fb8
...
Modernize the provided legacy codebase using Typescript | modular-monolith. Document current functionality and acceptance criteria, design architecture, implement rewritten services, run QA/security checks, validate requirements, and deploy for local Docker testing.

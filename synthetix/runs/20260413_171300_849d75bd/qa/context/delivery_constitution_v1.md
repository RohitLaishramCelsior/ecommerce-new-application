...
- Constitution ID: const-284a861ab9bd
- Run ID: 20260413_171300_849d75bd
...
Modernize the provided legacy codebase using TypeScript | docker-local | modular-monolith. Document current functionality and acceptance criteria, design architecture, implement rewritten services, run QA/security checks, validate requirements, and deploy for local Docker testing.
...
- Domain pack constraints must be applied: magicbox-staffing-v1.

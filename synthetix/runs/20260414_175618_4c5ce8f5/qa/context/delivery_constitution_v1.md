...
- Constitution ID: const-db278396acdf
- Run ID: 20260414_175618_4c5ce8f5
...
Modernize the provided legacy codebase using TypeScripti | docker-local | modular-monolith | Speed to parity, then performance. Document current functionality and acceptance criteria, design architecture, implement rewritten services, run QA/security checks, validate requirements, and deploy for local Docker testing.
